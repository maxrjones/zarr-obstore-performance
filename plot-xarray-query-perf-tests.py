...
# Read the data
data = pd.read_csv("results/xarray-query-timings.csv")
...
plt.title(
    "Single point query time in ARCO ERA5 dataset",
    fontsize=14,
)
...
# Save figure
plt.savefig("xarray_query_performance_comparison.png", dpi=300)
